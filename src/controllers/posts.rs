...
use crate::views::{posts, blog_post};
...
pub async fn get(Path(blog_url): Path<String>, DatabaseConnection(mut conn): DatabaseConnection) -> Result<Html<String>, DatabaseError> {
